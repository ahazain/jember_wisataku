...
import 'package:jember_wisataku/View/admin/editwisata.dart';
...
class HomeAdminKu extends StatefulWidget {
  @override
  _HomeAdminKuState createState() => _HomeAdminKuState();
}

class _HomeAdminKuState extends State<HomeAdminKu> {
  List _listdata = [];
  List _fullListData = [];
    ...
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => tambah_wisata()),
          );
        },
              ...
              child: IconButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => editData(attraction: attraction),
                    ),
                  );
                },
              ),
