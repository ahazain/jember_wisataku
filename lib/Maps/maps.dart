...
// import 'package:google_maps_flutter/google_maps_flutter.dart';
// import 'package:http/http.dart' as http;
// import 'package:jember_wisataku/Maps/api_keys.dart';
// import 'package:location/location.dart' as loc;

// import 'package:permission_handler/permission_handler.dart';

// class Maps extends StatefulWidget {
//   const Maps({Key? key, required Map<String, dynamic> attraction})
//       : super(key: key);
...
//           _cameraToPosition(_currentP!);
//         });
//         final coordinates = await getPolylinePoints(_currentP!);
//         if (coordinates.isNotEmpty) {
//           generatePolyLineFromPoints(coordinates);
//         } else {
//           ScaffoldMessenger.of(context).showSnackBar(SnackBar(
...
//   Future<List<LatLng>> getPolylinePoints(LatLng start) async {
//     List<LatLng> polylineCoordinates = [];
//     final String url =
//         'https://api.openrouteservice.org/v2/directions/driving-car?api_key=$ORS_API_KEY&start=${start.longitude},${start.latitude}&end=${_pGooglePlex.longitude},${_pGooglePlex.latitude}';
